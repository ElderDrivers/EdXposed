...
RIRU_EDXP="$(cat /proc/sys/kernel/random/uuid|md5sum|cut -c 1-8)"
...
LIB_WHALE_EDXP="lib$(cat /proc/sys/kernel/random/uuid|md5sum|cut -c 1-8).so"
LIB_SANDHOOK_EDXP="lib$(cat /proc/sys/kernel/random/uuid|md5sum|cut -c 1-8).so"
